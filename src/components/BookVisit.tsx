        ...
        >
          ...
          >
            ...
            <motion.a
              ...
              className="flex items-center justify-center gap-3 w-full py-4 sm:py-5 rounded-xl sm:rounded-2xl bg-[#25D366] hover:bg-[#1fb855] text-white font-bold text-sm sm:text-base md:text-lg transition-all duration-300 shadow-lg hover:shadow-xl mb-6 sm:mb-8"
